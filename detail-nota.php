...
$total_belanja = query("SELECT * FROM tb_transaksi INNER JOIN tb_ongkir on tb_transaksi.id_ongkir = tb_ongkir.id WHERE id_trans = $id_transaksi");
?>
...
<body>
  ...
  <div class="acc-container">
    <div class="tab-nota-container" id="cekWidth">
      <h2 class="judul-nota">NOTA <?= $_SESSION["pelanggan"]["nama"]; ?>
        <?php foreach($total_belanja as $tgl) { echo $tgl["tanggal"]; }; ?></h2>
      <ul class="responsive-nota-table">
        ...
        <li class="table-nota-row">
          ...
          <?php foreach($total_belanja as $ongkir): ?>
          <div class="col col-2" data-label="#">Ongkir <?= $ongkir["nama_kota"]; ?></div>

          <div class="col col-3" data-label="#"></div>
          <div class="col col-4" data-label="#"></div>


          <div class="col col-4" data-label="#">Rp. <?php echo number_format($ongkir["tarif"]); ?></div>
          <?php endforeach; ?>
        </li>
        <li class="table-nota-row">
          <div class="col col-1" data-label="#"></div>
