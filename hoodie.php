...
$db = query("SELECT * FROM katalog_depan");
            ...
            <div class="container-burger1" id="satsat">
                ...
                <div class="shop-container">
                    <div class="cart-shoping">
                        <a href="cart.php" class="shop-cart"><i class="fa fa-shopping-cart">
                            </i>
                            <div id="jumlah-cart">
                                <p><?= $jumlah_cart;?></p>
                            </div>
    ...
    <div class="tshirt-container">
        ...
        <div class="katalog-container">
            ...
            <div class="bungkus-display">
                <div class="hoodie-katalog">
                    <form class="form-hoodie"
                        action="detail.php?id=<?= $sample["id"];?>&kategori=<?= $sample["kategori"]; ?>" method="post">
                        <div class="wadah-img-hoodie">
